...
<body class="flex flex-col min-h-screen bg-gray-950 text-white">
    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4 ml-4">
              <a href="/" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Kezdőlap</a>
        ...
        <div class="flex items-center space-x-4">
            <a href="/login" class="hover:text-indigo-400">Bejelentkezés</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <footer class="bg-gray-900 text-gray-300 px-8 py-6">
