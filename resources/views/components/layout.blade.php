        ...
        <div class="flex items-center">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4 ml-4">
              ...
              <a href="/allergens" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Allergének</a>
              <a href="/restaurantsearch" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Étterem kereső</a>
            </div>
          </div>
        </div>
  ...
  <footer class="bg-[#40694f] text-gray-300 px-8 py-6">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
      ...
      <div class="flex space-x-6">
        <a href="/allergens" class="hover:text-indigo-400">Allergének</a>
        <a href="/restaurantsearch" class="hover:text-indigo-400">Étterem kereső</a>
        <a href="/about" class="hover:text-indigo-400">Rólunk</a>
      </div>
    </div>
  </footer>
